...
WORK="$(mktemp -d -t efipack-smoke-arm64-XXXXXX)"
...
module efipacksmoke_pack_arm64
go 1.25
...
run_one() {
    ...
    mcopy -i "$esp" "$packed_path" "::/EFI/BOOT/BOOTAA64.EFI"
    {
...
echo "=== M6.2 PR2 arm64 efipack smoke matrix ==="
